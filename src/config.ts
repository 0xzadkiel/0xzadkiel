...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    enable: true,
    src: 'assets/images/zadkiel_banner.png',   // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
  ...
  links: [
    ...
    },
    {
      ...
      url: 'https://github.com/0xzadkiel',
    },
  ],
}
